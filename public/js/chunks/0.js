...
/* harmony import */ var path_to_regexp_dist__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! path-to-regexp/dist */ "./node_modules/path-to-regexp/dist/index.js");
/* harmony import */ var path_to_regexp_dist__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(path_to_regexp_dist__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      active: 'dashboard',
      reduce: null,
      pathRegex: Object(path_to_regexp_dist__WEBPACK_IMPORTED_MODULE_0__["pathToRegexp"])('/:admin/:menu/(.*)*')
    };
  },
  computed: {
    sidebarIcon: function sidebarIcon() {
      return this.reduce ? 'bx bx-right-arrow-alt' : 'bx bx-left-arrow-alt';
    }
  },
  watch: {
  ...
  methods: {
    clickReduce: function clickReduce() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    Sidebar: _Components_Sidebar__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  computed: {
  ...
  mounted: function mounted() {
    ...
    _app__WEBPACK_IMPORTED_MODULE_6__["bus"].$on('reduce', function (reduce) {
      _this.reduce = reduce;
    });
  }
});
...
var render = function() {
  ...
  return _c(
    "vs-sidebar",
    {
      staticClass: "min-h-screen fixed",
      staticStyle: { position: "fixed !important" },
      attrs: { absolute: "", reduce: _vm.reduce, open: "" },
      scopedSlots: _vm._u([
        {
          key: "logo",
          fn: function() {
                        ...
                        "vs-button",
                        {
                          ...
                          nativeOn: {
                            click: function($event) {
                              return _vm.clickReduce($event)
                            }
                          }
                        },
                        [_c("i", { class: _vm.sidebarIcon })]
                      )
                    ],
                    1
                  )
    ...
    [
      ...
      _c(
        "vs-sidebar-item",
        {
          ...
          nativeOn: {
            click: function($event) {
              _vm.link(_vm.route("advantages.index"))
            }
          },
          scopedSlots: _vm._u([
            {
              key: "icon",
              fn: function() {
                return [_c("i", { staticClass: "bx bxs-bullseye" })]
              },
              proxy: true
            }
          ])
      ...
      _c(
        "vs-sidebar-item",
        {
          ...
          nativeOn: {
            click: function($event) {
              _vm.link(_vm.route("services.index"))
            }
          },
          scopedSlots: _vm._u([
            {
              key: "icon",
              fn: function() {
                return [_c("i", { staticClass: "bx bx-grid-alt" })]
              },
              proxy: true
            }
          ])
      ...
      _c(
        "vs-sidebar-item",
        {
          ...
          nativeOn: {
            click: function($event) {
              _vm.link(_vm.route("materials.index"))
            }
          },
          scopedSlots: _vm._u([
            {
      ...
      _c(
        "vs-sidebar-item",
        {
          ...
          nativeOn: {
            click: function($event) {
              _vm.link(_vm.route("galleries.index"))
            }
          },
          scopedSlots: _vm._u([
            {
      ...
      _c(
        "vs-sidebar-item",
        {
          ...
          nativeOn: {
            click: function($event) {
              _vm.link(
                _vm.route("contacts.edit", { contact: _vm.$page.contact_id })
              )
            }
          },
          scopedSlots: _vm._u([
            {
              key: "icon",
              fn: function() {
                return [_c("i", { staticClass: "bx bx-slider-alt" })]
              },
              proxy: true
            }
          ])
          ...
          scopedSlots: _vm._u([
            {
              key: "icon",
              fn: function() {
                return [_c("i", { staticClass: "bx bx-exit bx-rotate-180" })]
              },
              proxy: true
            }
          ])
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "flex" }, [
        _c(
          "div",
          { staticClass: "relative", style: _vm.widthStyle },
          [_c("sidebar")],
          1
        ),
        _vm._v(" "),
        _c(
          "main",
          { staticClass: "flex-auto px-4 py-4" },
          [_vm._t("default")],
          2
        )
      ]),
