      ...
      [
        _c("admin-component-div", { staticClass: "py-12" }, [
          ...
          _c(
            "form",
            {
              staticClass: "conform grid grid-cols-3 gap-2 w-full",
              on: {
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "flex flex-col space-y-6 border border-gray-200 rounded-xl p-3"
                },
                [
                      ...
                      [
                        _vm.form.error("title")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [_vm._v(_vm._s(_vm.form.error("title")))]
                              },
                              proxy: true
                            }
                          : null
                  ...
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _vm.form.error("keywords")
                      ? _c("p", { staticClass: "text-xs text-red-500" }, [
                          _vm._v(_vm._s(_vm.form.error("keywords")))
                        ])
                      : _vm._e()
                  ])
                ],
              ...
              _c(
                ...
                {
                  staticClass:
                    "flex flex-col space-y-8 border border-gray-200 rounded-xl p-3"
                },
                [
                  _c("p", { staticClass: "font-bold text-xl mb-4" }, [
                    _vm._v("Контакты")
                      ...
                      [
                        _vm.form.error("phone")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [_vm._v(_vm._s(_vm.form.error("phone")))]
                              },
                              proxy: true
                            }
                          : null
                      ...
                      [
                        _vm.form.error("email")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [_vm._v(_vm._s(_vm.form.error("email")))]
                              },
                              proxy: true
                            }
                          : null
                  ...
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _vm.form.error("address")
                      ? _c("p", { staticClass: "text-xs text-red-500" }, [
                          _vm._v(_vm._s(_vm.form.error("address")))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("vs-input", {
                    ...
                    scopedSlots: _vm._u(
                      [
                        _vm.form.error("instagram")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [
                                  _vm._v(_vm._s(_vm.form.error("instagram")))
                                ]
                              },
                              proxy: true
                            }
                  ...
                  _c("vs-input", {
                    ...
                    scopedSlots: _vm._u(
                      [
                        _vm.form.error("whatsapp")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [
                                  _vm._v(_vm._s(_vm.form.error("whatsapp")))
                                ]
                              },
                              proxy: true
                            }
                  ...
                  _c("vs-input", {
                    ...
                    scopedSlots: _vm._u(
                      [
                        _vm.form.error("yandex")
                          ? {
                              key: "message-danger",
                              fn: function() {
                                return [
                                  _vm._v(_vm._s(_vm.form.error("yandex")))
                                ]
                              },
                              proxy: true
                            }
              ...
              _c(
                ...
                [
                  ...
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _vm.form.error("google_script")
                      ? _c("p", { staticClass: "text-xs text-red-500" }, [
                          _vm._v(_vm._s(_vm.form.error("google_script")))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _vm.form.error("yandex_script")
                      ? _c("p", { staticClass: "text-xs text-red-500" }, [
                          _vm._v(_vm._s(_vm.form.error("yandex_script")))
                        ])
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", [
                    ...
                    _vm._v(" "),
                    _vm.form.error("other_script")
                      ? _c("p", { staticClass: "text-xs text-red-500" }, [
                          _vm._v(_vm._s(_vm.form.error("other_script")))
                        ])
                      : _vm._e()
                  ])
                ]
              ...
              _c(
                ...
                [
                  ...
                  _c("vs-input", {
                    ...
                    model: {
                      value: _vm.form.mail_to,
                      callback: function($$v) {
                        _vm.$set(_vm.form, "mail_to", $$v)
                      },
                      expression: "form.mail_to"
                    }
                  })
                ],
                1
